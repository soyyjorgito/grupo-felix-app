    ...
    <Dialog open={open} onOpenChange={(val) => !isUpdating && onClose()}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto bg-card text-card-foreground">
        ...
        <div className="space-y-6">
          ...
          {/* 2. Información del Cliente (Siempre existe por validación de form, pero usamos optional chaining por seguridad) */}
          ...
          <div className="space-y-2">
            ...
            <div className="text-sm space-y-1">
              {record.visit?.with_appointment && record.visit.with_appointment.length > 0 && (
                <p>
              ...
              {record.visit?.without_appointment && record.visit.without_appointment.length > 0 && (
                <p>
          ...
          {/* 5. Vehículo Actual (CORREGIDO: Verificación de Nulidad) */}
          {/* Verificamos primero que record.current_vehicle exista antes de leer sus propiedades */}
          {record.current_vehicle && (record.current_vehicle.brand || record.current_vehicle.model) && (
            <div className="space-y-2">
          ...
          {/* 6. Financiamiento (CORREGIDO: Verificación de Nulidad con Optional Chaining ?.) */}
          {record.financing && (
            <div className="space-y-2">
          ...
          {/* 7. PVA (Verificación de existencia) */}
          {record.pva && record.pva.length > 0 && (
            <div className="space-y-2">
          ...
          {/* 9. Firmas (CORREGIDO: Verificación de Nulidad) */}
          {record.signatures && (
            <div className="space-y-2">
